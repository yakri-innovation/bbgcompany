...
const navSections = [
  {
    label: "Pilotage",
    items: [
      { href: "/espace-client", label: "Tableau de bord", icon: "grid", exact: true },
      { href: "/espace-client/dossiers", label: "Dossiers", icon: "folder" }
    ]
  },
  {
    label: "Suivi",
    items: [
      ...
      { href: "/espace-client/paiements", label: "Paiements", icon: "card" }
    ]
  },
  {
    label: "Compte",
    items: [
      { href: "/espace-client/notifications", label: "Notifications", icon: "bell" },
      { href: "/espace-client/profil", label: "Profil", icon: "contact" }
    ]
  }
];
...
export default function ClientNav() {
  ...
  return (
    <nav className="admin-nav" aria-label="Navigation espace client">
